//
//  TestWhenPlayerWonEventSentItShouldContainWinningGuess.swift
//  GuessGameUnitTests
//
...
final class TestWhenPlayerWonEventSentItShouldContainWinningGuess: XCTestCase, GuessGameDelegate {
    var game: GuessGame!
    var players: [Player]!
