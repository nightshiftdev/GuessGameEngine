//
//  TestWhenGameConfiguredItCyclesThroughAllUsersAndFinishes.swift
//  GuessGameUnitTests
//
...
final class TestWhenGameConfiguredItCyclesThroughAllUsersAndFinishes: XCTestCase, GuessGameDelegate {
    var game: GuessGame!
    var players: [Player]!
    var playerIdx = 0
